...
Versión: `LTMD_U1_W7_COMMONCRAWL_SOURCE_DISCOVERY_0.3`.

Observado UTC: `2026-08-26T21:52:08.733782+00:00`.

Fase temporal: **2017–2020**, hasta **2** índices por año.
Índices seleccionados: `CC-MAIN-2017-04, CC-MAIN-2017-51, CC-MAIN-2018-05, CC-MAIN-2018-51, CC-MAIN-2019-04, CC-MAIN-2019-51, CC-MAIN-2020-05, CC-MAIN-2020-50`.
Esquemas exactos consultados por ruta: `http, https`.
...
|---|---:|---:|---:|---:|---:|---|---|---|
| `H2014P5FCA_page104` | 8 | 16 | 0 | 16 | 0 | `` | `` | `` |
| `H2018P3FCA_viewer` | 8 | 16 | 0 | 16 | 0 | `` | `` | `` |
| `H2018P4FCA_viewer` | 8 | 16 | 0 | 16 | 0 | `` | `` | `` |
| `H2018P5FCA_viewer` | 8 | 16 | 0 | 16 | 0 | `` | `` | `` |
| `H2018P6FCA_viewer` | 8 | 16 | 0 | 16 | 0 | `` | `` | `` |

## Página 104 de H2014P5FCA

Las variantes HTTP/HTTPS del URI exacto produjeron **0** captura(s) en esta fase, con **0/16** consultas de índice válidas.
