#!/usr/bin/env python3
"""Run the frozen W3 Spanish FRAGSEG engine on canonical W7 Civics/Ethics pages.
...
engine.STRUCTURE = Path('data/catalog/ltmd_u1_w7_civics_ethics_page_structure.csv')
engine.MANIFEST = Path('data/catalog/ltmd_u1_w7_canonical_page_manifest.csv')
engine.VERSION = 'FRAGSEG_LTMD_U1_W7_CIVICS_ETHICS_0.1'
engine.UA = 'LibroTextoMexicanoDigital/U1-W7 Civics Ethics FRAGSEG 0.1'

if '--output-dir' not in sys.argv:
    sys.argv.extend(['--output-dir', 'data/work/ltmd_u1_w7_civics_ethics_fragments'])
