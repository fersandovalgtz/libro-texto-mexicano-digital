...
def main():
 ...
 if len(viewers)!=EXPECTED:raise SystemExit(f'expected {EXPECTED} PAGESTRUCT viewers, found {len(viewers)}')
 ...
 if set(seen)!=viewers or len(seen)!=EXPECTED:raise SystemExit('viewer coverage mismatch')
