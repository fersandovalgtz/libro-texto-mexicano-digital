...
LABEL_ES={
 'W1':'Ciencias Naturales','W2':'Matemáticas','W3':'Español / Lengua','W4':'Ciencias Sociales','W5':'Historia','W6':'Geografía / Atlas','W7':'Formación Cívica y Ética','W8':'Artes','W9':'Educación Física','W10':'Integrados / Multiarea','W11':'Otros / No clasificados'}
LABEL_EN={
 'W1':'Natural Sciences','W2':'Mathematics','W3':'Spanish / Language','W4':'Social Sciences','W5':'History','W6':'Geography / Atlas','W7':'Civics and Ethics','W8':'Arts','W9':'Physical Education','W10':'Integrated / Multiarea','W11':'Other / Unclassified'}
...
def stage_es(r):
 ...
 if s=='ocr_complete_downstream_pending':return 'OCR completo; capas downstream pendientes'
...
def stage_en(r):
 ...
 if s=='ocr_complete_downstream_pending':return 'OCR complete; downstream layers pending'
 return f'queued ({plan})'

def pct(n):return f'{100*n/TOTAL:.2f}'

def badge_value(text):return quote(text,safe='·')
...
def sync_en(text,rows,eff,can):
 ...
 # English landing page intentionally remains compact; insert/update a wave table only if one already exists.
...
def main():
 ...
 es=sync_es(README_ES.read_text(encoding='utf-8'),rows,eff,can)
 en=sync_en(README_EN.read_text(encoding='utf-8'),rows,eff,can)
