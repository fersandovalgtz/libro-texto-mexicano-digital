#!/usr/bin/env python3
"""Run one deterministic LTMD-U1 W10 Integrados/Multiarea FTRL book unit.

Restricted OCR/SQLite/QC stay under local/ and must be encrypted before any
Actions upload. Public evidence is metadata/hash only. H2014P1ENA is excluded
upstream by the normalized input builder because its source is retained.
"""
