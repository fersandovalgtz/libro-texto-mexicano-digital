...
def main():
    w10_active=Path('docs/LTMD_U1_W10_FREEZE.md').exists();version='LTMD_U1_COVERAGE_0.12' if W10_COMPLETION.exists() else ('LTMD_U1_COVERAGE_0.11' if w10_active else ('LTMD_U1_COVERAGE_0.10' if W9_COMPLETION.exists() else 'LTMD_U1_COVERAGE_0.9'))
    ...
    for wave,domain,doc in WAVES:
        ...
        else:eff=can=0;stage='queued';evidence='data/catalog/ltmd_u1_wave_queue.csv'
