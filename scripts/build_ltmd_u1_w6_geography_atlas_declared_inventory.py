...
OUT=Path('data/catalog/ltmd_u1_w6_declared_inventory.csv')
SUMMARY=Path('data/catalog/ltmd_u1_w6_declared_inventory_summary.csv')
REPORT=Path('data/catalog/ltmd_u1_w6_declared_inventory.md')
VERSION='LTMD_U1_W6_DECLARED_INVENTORY_0.1'
EXPECTED=42
UA='LibroTextoMexicanoDigital/U1-W6 Geography Atlas declared inventory'
...
def main():
    ...
    if len(scope)!=EXPECTED or len(arch)!=EXPECTED:raise SystemExit(f'W6 scope/architecture mismatch {len(scope)}/{len(arch)}')
