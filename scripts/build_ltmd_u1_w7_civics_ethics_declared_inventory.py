...
ARCH=Path('data/catalog/ltmd_u1_w7_viewer_architecture.csv')
OUT=Path('data/catalog/ltmd_u1_w7_declared_inventory.csv')
SUMMARY=Path('data/catalog/ltmd_u1_w7_declared_inventory_summary.csv')
REPORT=Path('data/catalog/ltmd_u1_w7_declared_inventory.md')
VERSION='LTMD_U1_W7_DECLARED_INVENTORY_0.1'
EXPECTED=30
UA='LibroTextoMexicanoDigital/U1-W7 Civics Ethics declared inventory'
...
def main():
    ...
    if len(scope)!=EXPECTED or len(arch)!=EXPECTED:raise SystemExit(f'W7 scope/architecture mismatch {len(scope)}/{len(arch)}')
