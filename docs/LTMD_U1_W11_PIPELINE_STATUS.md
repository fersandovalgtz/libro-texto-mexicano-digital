...
Versión: `LTMD_U1_W11_PIPELINE_STATUS_0.2`. Observado: **2026-08-23T21:07:29.801012Z**.

> Observación operativa; no sustituye los reportes científicos de cada compuerta.

- Run observador: **32666468541**; job observador: **—**.

| etapa | run | estado API | conclusión | jobs | éxito | en curso | cola | fallos |
|---|---:|---|---|---:|---:|---:|---:|---:|
| G5 OCR | 32663100831 | `completed` | `success` | 108 | 108 | 0 | 0 | 0 |
| G6 PAGESTRUCT | 32665919946 | `queued` | `pendiente` | 107 | 88 | 8 | 11 | 0 |
| G6 FRAGSEG | 32664240478 | `completed` | `success` | 3 | 1 | 0 | 0 | 0 |
